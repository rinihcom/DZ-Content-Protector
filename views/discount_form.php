		...
		<table class="form-table">
			<tbody>
				<tr valign="top">
					...
					<td>
						<input class="regular-text" type="text" id="name" name="name" value="<?php echo $data->discount_name; ?>" />
					</td>
				</tr>
				<tr valign="top">
				...
				<tr valign="top">
					...
					<td>
						<input type="text" id="amount" name="amount" class="small-text" value="<?php echo $data->discount_amount; ?>" /> USD
					</td>
				</tr>
			</tbody>
		</table>
